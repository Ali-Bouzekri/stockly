...
final class SousCategorieController extends AbstractController
{
    ...
    #[Route('/{idSousCat}', name: 'app_sous_categorie_show', methods: ['GET'])]
    ...
    #[Route('/{idSousCat}/edit', name: 'app_sous_categorie_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idSousCat}', name: 'app_sous_categorie_delete', methods: ['POST'])]
    public function delete(Request $request, SousCategorie $sousCategorie, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$sousCategorie->getIdSousCat(), $request->getPayload()->getString('_token'))) {
